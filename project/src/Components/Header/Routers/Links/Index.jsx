        ...
        return(
            <>
                <div className="headerLinks">
                    ...
                    <Routers.Link to="../../../Pages/AddCart" className="routersLinks"><PiShoppingCart className="headerRoutersIcons"/></Routers.Link>
                    ...
                    <Routers.Link to="" className="routersLinks"><div className="linksCounterNumbers"><span className="numberOfValues">0</span></div></Routers.Link>
                    <Routers.Link to="../../../Pages/AddCart" className="routersLinks"><div className="linksCounterNumbers"><span className="numberOfValues">0</span></div></Routers.Link>
                    <Routers.Outlet/>
                </div>
            </>
        );
